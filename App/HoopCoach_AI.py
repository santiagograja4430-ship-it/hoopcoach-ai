print("ESTE ES EL NUEVO HOOPCOACH")
import cv2
import math
import time
...
def iniciar_entrenamiento():
    global estado_tiro, fase_actual_texto, tiempo_inicio_tiro, tiempo_fin_tiro
    global min_angulo_rodilla_tiro, max_angulo_codo_tiro, angulo_hombro_release
    global tiros_intentados, repeticiones_correctas, historial_puntajes, ultimo_puntaje, ultimo_consejo

    # Reiniciar métricas al iniciar una nueva sesión desde el menú
    estado_tiro = 0
    fase_actual_texto = "Listo para tirar"
    tiempo_inicio_tiro = 0
    tiempo_fin_tiro = 0
